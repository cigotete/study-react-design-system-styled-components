...
import { spaceSchema } from "../../utils";
import { InputGroup } from "../2-split-pattern/form";
import { Split } from "../2-split-pattern/InfoForm";
...
export const Column = styled.div`
  //whatever the value of $span is, it will be the min value between $span and the number of columns
